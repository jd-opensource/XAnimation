...
typedef void (^LOTLoadCompletionBlock)(BOOL loadFinished);
...
/// json 文件远程加载完成的回调，
/// 使用 -initWithContentsOfURL初始化时使用,当json文件下载失败，或者json格式错误返回NO；成功加载则返回YES。
@property (nonatomic, copy, nullable) LOTLoadCompletionBlock loadCompletionBlock;
